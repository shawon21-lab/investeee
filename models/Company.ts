...
const companySchema = new Schema<CompanyProps>(
  {
    ...
    nowPaymentApi: { type: String, trim: true, default: "not set" },
    address: {
      type: String,
      trim: true,
    ...
    color: {
      ...
      primaryLight: { type: String, trim: true, default: "#e35d56" },
      primaryVeryLight: { type: String, trim: true, default: "#f2dcdc" },
    },
